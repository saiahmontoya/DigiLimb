...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x84f4778bc583ba75, ; from name: mongocrypt.so
		i64 u0xdce7fbb157c28742, ; uint64_t real_name_hash
		i1 false, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 u0xa7c997ab2230b1ee, ; from name: mongocrypt
		i64 u0xdce7fbb157c28742, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libmongocrypt.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xcd545b9bcf367955, ; from name: libmongocrypt
		i64 u0xdce7fbb157c28742, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libmongocrypt.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdce7fbb157c28742, ; from name: libmongocrypt.so
		i64 u0xdce7fbb157c28742, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libmongocrypt.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.digilimbdesktop\00", align 16
